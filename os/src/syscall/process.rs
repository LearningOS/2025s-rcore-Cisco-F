...
pub fn sys_get_time(ts: *mut TimeVal, _tz: usize) -> isize {
    ...
    let token = current_user_token();
    let mut buffers = translated_byte_buffer(token, ts as *const _ as *const u8, core::mem::size_of::<TimeVal>());
    let src = unsafe {
        core::slice::from_raw_parts(&time as *const _ as *const u8, core::mem::size_of::<TimeVal>())
    };
